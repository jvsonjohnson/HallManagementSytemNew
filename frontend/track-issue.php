...
<body>
  <div data-collapse="medium" data-animation="default" data-duration="400" class="navbar w-nav">
    <div class="w-container">
      <nav role="navigation" class="w-nav-menu"><a href="old-home.php" class="navbtn w-button">Back</a></nav><a href="old-home.php" class="nav-link w-nav-link">Home</a><a href="index.php" class="nav-link w-nav-link">Sign Out</a>
